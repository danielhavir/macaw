...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--sac_objective", action="store_true")
    parser.add_argument("--entropy_alpha_coef", type=float, default=1.0)
    parser.add_argument("--learned_alpha", action="store_true")
